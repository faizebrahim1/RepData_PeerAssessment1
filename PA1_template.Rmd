...
```{r Daily Step Histogram excl. NA, fig.width=10 }
require(ggplot2)
...
#### Time Series Plot
```{r Time Plot Daily Activity NA removed, fig.width=10}
...
```{r Daily Step Histogram NA imputed, fig.width=10}
require(ggplot2)
...
```{r Time Plot Weekend v Weekday Activity }
